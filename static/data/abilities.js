...
exports.BattleAbilities = {
    ...
    "burstingjets": {
                desc: "Raises the user's Speed stat by two stages when a stat is lowered, including the Speed stat. This does not include self-induced stat drops like those from Close Combat.",
                shortDesc: "This Pokemon's Speed is boosted by 2 for each of its stats that is lowered by a foe.",
                onAfterEachBoost: function(boost, target, source) {
                        if (!source || target.side === source.side) {
                                return;
                        }
	...
	"dimensionwarp": {
		desc: "When this Pokemon enters the battlefield, the weather becomes Sunny Day (for 7 turns normally, or 9 turns while having persistent).",
		shortDesc: "On switch-in, sets Trick Room.",
		onStart: function(source) {

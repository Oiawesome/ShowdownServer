(function(exports, $) {
	...
	var TeambuilderRoom = exports.TeambuilderRoom = exports.Room.extend({
		...
		updateTeamList: function() {
			...
			if (!teams) {
				buf = '<div class="pad"><p>lol Oiawesome this is a horrible teambuilder</p>'
				buf += '<p>that\'s because we\'re not done loading it you fucking whore D:<...</p></div>';
				this.$el.html(buf);
				return;
			}
			buf = '<div class="pad"><p>y\'know oiawesome this is a pretty good teambuilder</p>'
			buf += '<p>NOW you like it? bitch please</p>'
			buf += '<ul>';
		...
		arrangeCallback: {
			pokemon: function(pokemon) {
				if (!pokemon) {
					...
					return ['OU','Kalos Uber','Uber','Jokemons','BL','Limbo A','Limbo B','Limbo C','Limbo','NFE','LC Uber','LC','Unreleased','Kalos CAP','CAP'];
				}
